            ...
            <section>
                <div className="content">
                        ...
                        <p style={{ marginRight: "auto" }} className="welcomefont">
                          <Link to="/user" style={{textDecoration : 'none'}}>Create sharing food</Link>
                        </p>
                      </div>
                <h1 className='welcomefont'>{`${translate("amount")} : ${amount}`}</h1>
                <form>
                    <label className='welcomefont' htmlFor="locaMore">{translate("more") + " :"}</label>
                    ...
                    <input type="file" accept="image/*" id="locaImages" name="locaImages" onChange={onImageChange} multiple disabled={true}   />
                    <div>
